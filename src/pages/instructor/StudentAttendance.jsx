...
import { FiActivity, FiEdit2, FiChevronRight, FiChevronLeft, FiFilter } from 'react-icons/fi';
import { fetchAttendanceRecords, selectAttendanceRecords, selectAttendancePagination, selectAttendanceLoading } from '../../store/slices/attendanceSlice';
...
export default function StudentAttendance() {
  ...
  useEffect(() => {
    ...
    // The backend automatically filters by instructor's courses if role === INSTRUCTOR
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h1 className="text-2xl font-extrabold text-gray-900">سجلات حضور الطلاب</h1>
      </div>
